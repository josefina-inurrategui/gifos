...
const uploadURL = "https://upload.giphy.com/v1/gifs?api_key=WWgW3UIDG6hoX2VO5lpRgcTEf0DRmaQF";
const cancel = document.getElementById("cancel");
const topUpload = document.getElementById("top_upload");
let arrayMyGIfs = [];
const gifsResults = document.getElementById("mygifos_result");
const apiKey = "WWgW3UIDG6hoX2VO5lpRgcTEf0DRmaQF";
let urlGif = "";
let blob = null;
...
btnCapture.addEventListener("click",async () => {
    ...
    document.querySelector("#btnImg img").src = "images/recording.svg";
...
function repeatAll(){
    ...
    document.querySelector("#btnImg img").src = "images/camera.svg";
